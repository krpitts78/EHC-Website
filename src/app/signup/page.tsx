...
export default function SignupPage() {
  ...
  return (
    <main className="flex flex-1 flex-col items-center justify-center bg-[#333F48] px-6 py-16">
      ...
      >
        <h1 className="text-2xl font-semibold text-[#333F48]">Create account</h1>
        <p className="mt-2 text-sm text-[#5a6470]">
          Use the email address on file with the club.
        </p>

        <label className="mt-6 block text-sm font-medium text-[#5a6470]">
          Email
          <input
            type="email"
            name="email"
            required
            autoComplete="email"
            className="mt-1 w-full rounded border border-[#d4c89c] bg-white px-3 py-2 text-[#333F48] focus:border-[#BF5700] focus:outline-none"
          />
        </label>

        <label className="mt-4 block text-sm font-medium text-[#5a6470]">
          Password
          <input
            type="password"
            name="password"
        ...
        <p className="mt-4 text-center text-sm text-[#5a6470]">
